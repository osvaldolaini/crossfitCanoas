    ...
    public function store(Request $request)
    {
        ...
        if($partner->save()){
            if(isset($request->image)){
                ...
                Storage::move('public/tmp/'.$request->image, 'public/images/partners/'.$partner->id.'/'.$partner->image);
                 /*Thumbnail */
                 Functions::thumbnail('storage/images/partners/'.$partner->id.'/'.$partner->image,'storage/images/partners/'.$partner->id,120);
        ...
        if($partner){
            $data = array(
                ...
                'body'  => array(
                    ...
                    'image'             => ($partner->image ? url('storage/images/partners/'.$partner->id.'/'.$partner->image) : url('storage/images/logos/logo.png') ),
                )
            );
            return response()->json(
                [
