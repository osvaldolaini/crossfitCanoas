...
class ArticleController extends Controller
{
    ...
    private $configs = array(
        'new'                   => 'Novo artigo ',
        'msg-success-save'      => 'Artigo cadastrada com sucesso',
    ...
    public function index()
    {
        ...
        if (isset($articles)) {
            ...
            foreach ($articles as $article) {
                $buttons = Functions::buttons($article->id,10,$this->configs['location'],true,'articles|'.$article->id);
                $data[]=array(
        ...
        if($article->save()){
            ...
            if(isset($images)){
                for ($i=0; $i < count($images); $i++) {
                    ...
                    $thumb = $article->slug.'-'.$i.'-thumbnail';
                    ...
                    /*Thumbnail */
                    Functions::uploadImage('storage/images/articles/'.$article->id.'/'.$new_name,'storage/images/articles/'.$article->id,$thumb,99,66,true);
        ...
        if($article){
            ...
            $data = array(
                ...
                'body'  => array(
                    ...
                    'Enviado em'        => ($article->send_at ? date( 'd/m/Y H:i' , strtotime($article->send_at)) : ""),
                    'Enviado por'       => $article->send_by,
