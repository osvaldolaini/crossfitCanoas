    ...
    <script src="{{asset('site/template/vendor/jquery.plugins/jquery.animateNumber.min.js') }}"></script>
    <script src="{{asset('site/template/vendor/jquery.plugins/jquery.waypoints.min.js') }}"></script>
    <script src="{{asset('site/template/vendor/jquery.plugins/jquery.magnific-popup.min.js') }}"></script>
